function varargout = ea_stimparams_aleva(varargin)
%EA_STIMPARAMS_ALEVA MATLAB code file for ea_stimparams_aleva.fig
%      EA_STIMPARAMS_ALEVA, by itself, creates a new EA_STIMPARAMS_ALEVA or raises the existing
%      singleton*.
%
%      H = EA_STIMPARAMS_ALEVA returns the handle to a new EA_STIMPARAMS_ALEVA or the handle to
%      the existing singleton*.
%
%      EA_STIMPARAMS_ALEVA('Property','Value',...) creates a new EA_STIMPARAMS_ALEVA using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to ea_stimparams_aleva_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      EA_STIMPARAMS_ALEVA('CALLBACK') and EA_STIMPARAMS_ALEVA('CALLBACK',hObject,...) call the
%      local function named CALLBACK in EA_STIMPARAMS_ALEVA.M with the given input
%      arguments.
%
...
% Edit the above text to modify the response to help ea_stimparams_aleva

% Last Modified by GUIDE v2.5 22-Sep-2021 16:59:26

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @ea_stimparams_aleva_OpeningFcn, ...
                   'gui_OutputFcn',  @ea_stimparams_aleva_OutputFcn, ...
                   'gui_LayoutFcn',  [], ...
                   'gui_Callback',   []);
...
% --- Executes just before ea_stimparams_aleva is made visible.
function ea_stimparams_aleva_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = ea_stimparams_aleva_OutputFcn(hObject, eventdata, handles)
...
% hObject    handle to k20u (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of k20u as text
%        str2double(get(hObject,'String')) returns contents of k20u as a double
S=getappdata(handles.stimfig,'S'); options=getappdata(handles.stimfig,'options');

eval(['S.Rs',num2str(S.active(1)),'.k8.perc=',num2str(get(hObject,'String')),';']);
...
eval(['S.Rs',num2str(S.active(1)),'.k8.imp=',num2str(get(hObject,'String')),';']);
...
%        str2double(get(hObject,'String')) returns contents of k22u as a double
S=getappdata(handles.stimfig,'S'); options=getappdata(handles.stimfig,'options');

eval(['S.Rs',num2str(S.active(1)),'.k9.perc=',num2str(get(hObject,'String')),';']);
...
eval(['S.Rs',num2str(S.active(1)),'.k9.imp=',num2str(get(hObject,'String')),';']);
...
% Hints: get(hObject,'String') returns contents of k22u as text
%        str2double(get(hObject,'String')) returns contents of k22u as a double
S=getappdata(handles.stimfig,'S'); options=getappdata(handles.stimfig,'options');

eval(['S.Rs',num2str(S.active(1)),'.k10.perc=',num2str(get(hObject,'String')),';']);
...
eval(['S.Rs',num2str(S.active(1)),'.k10.imp=',num2str(get(hObject,'String')),';']);
...
% hObject    handle to k23u (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of k23u as text
%        str2double(get(hObject,'String')) returns contents of k23u as a double
S=getappdata(handles.stimfig,'S'); options=getappdata(handles.stimfig,'options');

eval(['S.Rs',num2str(S.active(1)),'.k11.perc=',num2str(get(hObject,'String')),';']);
...
eval(['S.Rs',num2str(S.active(1)),'.k11.imp=',num2str(get(hObject,'String')),';']);
...
eval(['S.Ls',num2str(S.active(1)),'.k12.imp=',num2str(get(hObject,'String')),';']);
...
function k16u_Callback(hObject, eventdata, handles)
% hObject    handle to k16u (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of k16u as text
%        str2double(get(hObject,'String')) returns contents of k16u as a double
S=getappdata(handles.stimfig,'S'); options=getappdata(handles.stimfig,'options');

eval(['S.Ls',num2str(S.active(2)),'.k16.perc=',num2str(get(hObject,'String')),';']);

setappdata(handles.stimfig,'S',S);
ea_refreshguisp(handles,options,hObject);

% --- Executes during object creation, after setting all properties.
function k16u_CreateFcn(hObject, eventdata, handles)
% hObject    handle to k16u (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function k16im_Callback(hObject, eventdata, handles)
% hObject    handle to k16im (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of k16im as text
%        str2double(get(hObject,'String')) returns contents of k16im as a double
S=getappdata(handles.stimfig,'S'); options=getappdata(handles.stimfig,'options');

eval(['S.Ls',num2str(S.active(2)),'.k16.imp=',num2str(get(hObject,'String')),';']);

setappdata(handles.stimfig,'S',S);
ea_refreshguisp(handles,options);

% --- Executes during object creation, after setting all properties.
function k16im_CreateFcn(hObject, eventdata, handles)
% hObject    handle to k16im (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function k17u_Callback(hObject, eventdata, handles)
% hObject    handle to k17u (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of k17u as text
%        str2double(get(hObject,'String')) returns contents of k17u as a double
S=getappdata(handles.stimfig,'S'); options=getappdata(handles.stimfig,'options');

eval(['S.Ls',num2str(S.active(2)),'.k17.perc=',num2str(get(hObject,'String')),';']);

setappdata(handles.stimfig,'S',S);
ea_refreshguisp(handles,options,hObject);

% --- Executes during object creation, after setting all properties.
function k17u_CreateFcn(hObject, eventdata, handles)
% hObject    handle to k17u (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function k17im_Callback(hObject, eventdata, handles)
% hObject    handle to k17im (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of k17im as text
%        str2double(get(hObject,'String')) returns contents of k17im as a double
S=getappdata(handles.stimfig,'S'); options=getappdata(handles.stimfig,'options');

eval(['S.Ls',num2str(S.active(2)),'.k17.imp=',num2str(get(hObject,'String')),';']);

setappdata(handles.stimfig,'S',S);
ea_refreshguisp(handles,options);

% --- Executes during object creation, after setting all properties.
function k17im_CreateFcn(hObject, eventdata, handles)
% hObject    handle to k17im (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function k18u_Callback(hObject, eventdata, handles)
% hObject    handle to k18u (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of k18u as text
%        str2double(get(hObject,'String')) returns contents of k18u as a double
S=getappdata(handles.stimfig,'S'); options=getappdata(handles.stimfig,'options');

eval(['S.Ls',num2str(S.active(2)),'.k18.perc=',num2str(get(hObject,'String')),';']);

setappdata(handles.stimfig,'S',S);
ea_refreshguisp(handles,options,hObject);

% --- Executes during object creation, after setting all properties.
function k18u_CreateFcn(hObject, eventdata, handles)
% hObject    handle to k18u (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function k18im_Callback(hObject, eventdata, handles)
% hObject    handle to k18im (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of k18im as text
%        str2double(get(hObject,'String')) returns contents of k18im as a double
S=getappdata(handles.stimfig,'S'); options=getappdata(handles.stimfig,'options');

eval(['S.Ls',num2str(S.active(2)),'.k18.imp=',num2str(get(hObject,'String')),';']);

setappdata(handles.stimfig,'S',S);
ea_refreshguisp(handles,options);

% --- Executes during object creation, after setting all properties.
function k18im_CreateFcn(hObject, eventdata, handles)
% hObject    handle to k18im (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function k19u_Callback(hObject, eventdata, handles)
% hObject    handle to k19u (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of k19u as text
%        str2double(get(hObject,'String')) returns contents of k19u as a double
S=getappdata(handles.stimfig,'S'); options=getappdata(handles.stimfig,'options');

eval(['S.Ls',num2str(S.active(2)),'.k19.perc=',num2str(get(hObject,'String')),';']);

setappdata(handles.stimfig,'S',S);
ea_refreshguisp(handles,options,hObject);

% --- Executes during object creation, after setting all properties.
function k19u_CreateFcn(hObject, eventdata, handles)
% hObject    handle to k19u (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function k19im_Callback(hObject, eventdata, handles)
% hObject    handle to k19im (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of k19im as text
%        str2double(get(hObject,'String')) returns contents of k19im as a double
S=getappdata(handles.stimfig,'S'); options=getappdata(handles.stimfig,'options');

eval(['S.Ls',num2str(S.active(2)),'.k19.imp=',num2str(get(hObject,'String')),';']);

setappdata(handles.stimfig,'S',S);
ea_refreshguisp(handles,options);

% --- Executes during object creation, after setting all properties.
function k19im_CreateFcn(hObject, eventdata, handles)
% hObject    handle to k19im (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function k20u_Callback(hObject, eventdata, handles)
% hObject    handle to k21u (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of k21u as text
%        str2double(get(hObject,'String')) returns contents of k21u as a double
S=getappdata(handles.stimfig,'S'); options=getappdata(handles.stimfig,'options');

eval(['S.Ls',num2str(S.active(2)),'.k20.perc=',num2str(get(hObject,'String')),';']);

setappdata(handles.stimfig,'S',S);
ea_refreshguisp(handles,options,hObject);

% --- Executes during object creation, after setting all properties.
function k20u_CreateFcn(hObject, eventdata, handles)
% hObject    handle to k21u (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function k20im_Callback(hObject, eventdata, handles)
% hObject    handle to k20im (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of k20im as text
%        str2double(get(hObject,'String')) returns contents of k20im as a double
S=getappdata(handles.stimfig,'S'); options=getappdata(handles.stimfig,'options');

eval(['S.Ls',num2str(S.active(2)),'.k20.imp=',num2str(get(hObject,'String')),';']);

setappdata(handles.stimfig,'S',S);
ea_refreshguisp(handles,options);

% --- Executes during object creation, after setting all properties.
function k20im_CreateFcn(hObject, eventdata, handles)
% hObject    handle to k20im (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function k21u_Callback(hObject, eventdata, handles)
% hObject    handle to k21u (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
eval(['S.Ls',num2str(S.active(2)),'.k21.perc=',num2str(get(hObject,'String')),';']);

setappdata(handles.stimfig,'S',S);
ea_refreshguisp(handles,options,hObject);

% --- Executes during object creation, after setting all properties.
function k21u_CreateFcn(hObject, eventdata, handles)
% hObject    handle to k21u (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function k21im_Callback(hObject, eventdata, handles)
% hObject    handle to k21im (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of k21im as text
%        str2double(get(hObject,'String')) returns contents of k21im as a double
S=getappdata(handles.stimfig,'S'); options=getappdata(handles.stimfig,'options');

eval(['S.Ls',num2str(S.active(2)),'.k21.imp=',num2str(get(hObject,'String')),';']);

setappdata(handles.stimfig,'S',S);
ea_refreshguisp(handles,options);

% --- Executes during object creation, after setting all properties.
function k21im_CreateFcn(hObject, eventdata, handles)
% hObject    handle to k21im (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function k22u_Callback(hObject, eventdata, handles)
% hObject    handle to k22u (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
eval(['S.Ls',num2str(S.active(2)),'.k22.perc=',num2str(get(hObject,'String')),';']);

setappdata(handles.stimfig,'S',S);
ea_refreshguisp(handles,options,hObject);

% --- Executes during object creation, after setting all properties.
function k22u_CreateFcn(hObject, eventdata, handles)
% hObject    handle to k22u (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function k22im_Callback(hObject, eventdata, handles)
% hObject    handle to k22im (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of k22im as text
%        str2double(get(hObject,'String')) returns contents of k22im as a double
S=getappdata(handles.stimfig,'S'); options=getappdata(handles.stimfig,'options');

eval(['S.Ls',num2str(S.active(2)),'.k22.imp=',num2str(get(hObject,'String')),';']);

setappdata(handles.stimfig,'S',S);
ea_refreshguisp(handles,options);

% --- Executes during object creation, after setting all properties.
function k22im_CreateFcn(hObject, eventdata, handles)
% hObject    handle to k22im (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function k23u_Callback(hObject, eventdata, handles)
% hObject    handle to k23u (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
eval(['S.Ls',num2str(S.active(2)),'.k23.perc=',num2str(get(hObject,'String')),';']);

setappdata(handles.stimfig,'S',S);
ea_refreshguisp(handles,options,hObject);

% --- Executes during object creation, after setting all properties.
function k23u_CreateFcn(hObject, eventdata, handles)
% hObject    handle to k23u (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function k23im_Callback(hObject, eventdata, handles)
% hObject    handle to k23im (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of k23im as text
%        str2double(get(hObject,'String')) returns contents of k23im as a double
S=getappdata(handles.stimfig,'S'); options=getappdata(handles.stimfig,'options');

eval(['S.Ls',num2str(S.active(2)),'.k23.imp=',num2str(get(hObject,'String')),';']);

setappdata(handles.stimfig,'S',S);
ea_refreshguisp(handles,options);

% --- Executes during object creation, after setting all properties.
function k23im_CreateFcn(hObject, eventdata, handles)
% hObject    handle to k23im (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on selection change in stimlabel.
function stimlabel_Callback(hObject, eventdata, handles)
% hObject    handle to stimlabel (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns stimlabel contents as cell array
%        contents{get(hObject,'Value')} returns selected item from stimlabel
S=getappdata(handles.stimfig,'S');
options=getappdata(handles.stimfig,'options');
directory = [options.root,options.patientname,filesep];
    ...
    if ischar(varargin{3})
        switch varargin{3}
            case {'Rcase'}
                ...
                ks={'k0','k1','k2','k3','k4','k5','k6','k7','k8','k9','k10','k11'};
                sidec='R'; side=1;
            ...
            case {'Lcase'}
                ...
                ks={'k12','k13','k14','k15','k16','k17','k18','k19','k20','k21','k22','k23'};
                sidec='L'; side=2;
                S=ea_redistribute_voltage(S,varargin{3});
            ...
            otherwise
                ...
                switch varargin{3}
                    case {'k0','k1','k2','k3','k4','k5','k6','k7','k8','k9','k10','k11'}
                        sidec='R'; side=1;
                    case {'k12','k13','k14','k15','k16','k17','k18','k19','k20','k21','k22','k23'}
                        sidec='L'; side=2;
                end
...
for source=1:4
    ...
    if ~anycontactnegative
        eval(['S.Ls',num2str(source),'.k14.pol=1;']);
        eval(['S.Ls',num2str(source),'.k14.perc=100;']);
    end
    if ~anycontactpositive
...
if options.elspec.numel<=8 || contains(options.elspec.matfname, 'aleva')
...
for i=0:2
    set(handles.(['perctext',num2str(ptval+i)]),'visible',onoff);
end
...
Rconts={'k0','k1','k2','k3','k4','k5','k6','k7','k8','k9','k10','k11'};
Lconts={'k12','k13','k14','k15','k16','k17','k18','k19','k20','k21','k22','k23'};
