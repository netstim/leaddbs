...
if ~exist([earoot,'connectomes',filesep,'dMRI'],'file') || ...
        ~exist([earoot,'connectomes',filesep,'dMRI',filesep,'Groupconnectome (Horn 2013) full.mat'],'file') || ...
        ~exist([earoot,'connectomes',filesep,'dMRI',filesep,'Groupconnectome (Horn 2013) thinned out x 2.mat'],'file') || ...
        ~exist([earoot,'connectomes',filesep,'dMRI',filesep,'Groupconnectome (Horn 2013) thinned out x 5.mat'],'file') || ...
        ~exist([earoot,'connectomes',filesep,'dMRI',filesep,'Groupconnectome (Horn 2013) thinned out x 5.mat'],'file') || ...
        ~exist([earoot,'connectomes',filesep,'dMRI',filesep,'Groupconnectome (Horn 2013) thinned out x 10.mat'],'file') || ...
        ~exist([earoot,'connectomes',filesep,'dMRI',filesep,'Groupconnectome (Horn 2013) thinned out x 50.mat'],'file') || ...
        ~exist([earoot,'connectomes',filesep,'dMRI',filesep,'Groupconnectome (Horn 2013) thinned out x 100.mat'],'file') || ...
        ~exist([earoot,'connectomes',filesep,'dMRI',filesep,'Groupconnectome (Horn 2013) thinned out x 500.mat'],'file')
