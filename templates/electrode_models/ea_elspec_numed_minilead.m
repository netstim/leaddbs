function electrode = ea_elspec_numed_minilead(vizz)
% Creates the FEM-compatible electrode model for NuMed Mini Lead.
...
modelFolder = 'NuMedMiniLead';

% Get specification
options.elmodel = 'NuMed Mini Lead';
