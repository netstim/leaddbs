function electrode=ea_elspec_dixi_d08_18am(varargin)
...
for iside=1:length(options.sides)
    ...
    coords_mm{side}=[0,0,(elspec.contact_length/2);...
        ...
        0,0,(elspec.contact_length/2)+15*(elspec.contact_spacing+elspec.contact_length);...
        0,0,(elspec.contact_length/2)+16*(elspec.contact_spacing+elspec.contact_length);...
        0,0,(elspec.contact_length/2)+17*(elspec.contact_spacing+elspec.contact_length)];
