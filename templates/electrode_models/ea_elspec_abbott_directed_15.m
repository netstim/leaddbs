function electrode=ea_elspec_abbott_directed_15(varargin)
...
modelFolder = 'Abbott_Directed_15';
...
save([elemodelPath,filesep,'abbott_directed_15.mat'],'electrode');

%% create and save _vol file
filename = [elemodelPath,filesep,modelFolder,filesep,'final.1'];
[node,~,face]=readtetgen(filename);
save([elemodelPath,filesep,'abbott_directed_15_vol.mat'],'face','node')
clear node face
