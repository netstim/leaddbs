...
trajectory{side}=[linspace(trajectory{side}(1,1),trajectory{side}(2,1),40)',...
    linspace(trajectory{side}(1,2),trajectory{side}(2,2),40)',...
    linspace(trajectory{side}(1,3),trajectory{side}(2,3),40)'];
