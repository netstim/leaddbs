function electrode=ea_elspec_adtech_bf08r_sp21x(varargin)
...
options.elmodel='AdTech BF08R-SP21X';
...
elspec.contact_spacing = cellfun(@times, elspec.contact_spacing, {rescaleratio, rescaleratio});
...
for iside=1:length(options.sides)
    ...
    coords_mm{side}=[0,0,elspec.tip_length+(elspec.contact_length/2);...
        0,0,elspec.tip_length+(elspec.contact_length/2)+(elspec.contact_spacing(1)+elspec.contact_length);...
        0,0,elspec.tip_length+(elspec.contact_length/2)+(elspec.contact_spacing(1)+elspec.contact_length)+1*(elspec.contact_spacing(2)+elspec.contact_length);...
        0,0,elspec.tip_length+(elspec.contact_length/2)+(elspec.contact_spacing(1)+elspec.contact_length)+2*(elspec.contact_spacing(2)+elspec.contact_length);...
        0,0,elspec.tip_length+(elspec.contact_length/2)+(elspec.contact_spacing(1)+elspec.contact_length)+3*(elspec.contact_spacing(2)+elspec.contact_length);...
        0,0,elspec.tip_length+(elspec.contact_length/2)+(elspec.contact_spacing(1)+elspec.contact_length)+4*(elspec.contact_spacing(2)+elspec.contact_length);...
        0,0,elspec.tip_length+(elspec.contact_length/2)+(elspec.contact_spacing(1)+elspec.contact_length)+5*(elspec.contact_spacing(2)+elspec.contact_length);...
        0,0,elspec.tip_length+(elspec.contact_length/2)+(elspec.contact_spacing(1)+elspec.contact_length)+6*(elspec.contact_spacing(2)+elspec.contact_length)];
    ...
    for cntct=1:elspec.numel-1
        ...
        % separate calculation for first contact
        if cntct == 1
            cZ=cZ.*(elspec.contact_spacing(1)); % scale to fit tip-diameter
            htd=(max(cZ(:))/2);
            cZ=cZ-htd;
            hait=coords_mm{side}(cntct,3)+elspec.contact_length/2+elspec.contact_spacing(1)/2;
            cZ=cZ+hait;
        else
            cZ=cZ.*(elspec.contact_spacing(2)); % scale to fit tip-diameter
            htd=(max(cZ(:))/2);
            cZ=cZ-htd;
            hait=coords_mm{side}(cntct,3)+elspec.contact_length/2+elspec.contact_spacing(2)/2;
            cZ=cZ+hait;
        end
...
electrode.tail_position=[0,0,elspec.tip_length+4*elspec.contact_length+elspec.contact_spacing(1)+(4-2)*elspec.contact_spacing(2)-0.5*elspec.contact_length];
...
ea_genvol_adtech_bf(meshel,elspec,rescaleratio,vizz);
