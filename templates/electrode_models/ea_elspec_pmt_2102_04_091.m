function electrode = ea_elspec_pmt_2102_04_091(vizz)
% Creates the FEM-compatible electrode model for PMT 2102-04-091.
% It's based on the mesh generated using Blender and tetgen.
% _________________________________________________________________________
% Ningfei Li

% Set folder
elemodelPath = fileparts(mfilename('fullpath'));
modelFolder = 'PMT_2102-04-091';

% Get specification
options.elmodel = 'PMT 2102-04-091';
