function electrode = ea_elspec_boston_vercise_cartesia_hx(vizz)
% Creates the FEM-compatible electrode model for Boston Scientific Vercise Cartesia HX.
% Based on the mesh generated using Blender and tetgen, script from by Johannes Achtzehn.
...
modelFolder = 'Boston_Scientific_Vercise_Cartesia_HX';

% Get specification
options.elmodel = 'Boston Scientific Vercise Cartesia HX';
...
electrode.coords_mm = zeros(elspec.numContacts,3);
...
% Normal contacts
for ind=levelIndStart+3:elspec.numContacts
    level = level + 1;
