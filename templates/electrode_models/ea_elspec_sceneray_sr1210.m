function electrode = ea_elspec_sceneray_sr1210(vizz)
% Creates the FEM-compatible electrode model for SceneRay SR1210.
...
modelFolder = 'SceneRay_SR1210';

% Get specification
options.elmodel = 'SceneRay SR1210';
