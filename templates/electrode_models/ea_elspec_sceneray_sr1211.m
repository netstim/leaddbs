function electrode = ea_elspec_sceneray_sr1211(vizz)
% Creates the FEM-compatible electrode model for SceneRay SR1211.
...
modelFolder = 'SceneRay_SR1211';

% Get specification
options.elmodel = 'SceneRay SR1211';
