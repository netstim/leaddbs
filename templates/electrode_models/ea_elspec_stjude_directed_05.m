...
modelFolder = 'StJude_Directed_05';
...
save([elemodelPath,filesep,'stjude_directed_05.mat'],'electrode');

%% create and save _vol file
filename = [elemodelPath,filesep,modelFolder,filesep,'final.1'];
[node,~,face]=readtetgen(filename);
save([elemodelPath,filesep,'stjude_directed_05_vol.mat'],'face','node')
clear node face
