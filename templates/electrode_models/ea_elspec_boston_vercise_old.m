function electrode=ea_elspec_bostonvercise(varargin)
...
for side=1:length(options.sides)
    %% nullmodel:
    coords_mm{side}=[0,0,1.5+0.75;0,0,1.5+0.75+1*2;0,0,1.5+0.75+2*2;0,0,1.5+0.75+3*2;0,0,1.5+0.75+4*2;0,0,1.5+0.75+5*2;0,0,1.5+0.75+6*2;0,0,1.5+0.75+7*2];
...
electrode.tail_position=[0,0,options.elspec.tip_length+4*options.elspec.contact_length+(4-1)*options.elspec.contact_spacing-0.5*options.elspec.contact_length];
