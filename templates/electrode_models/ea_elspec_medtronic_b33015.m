function electrode=ea_elspec_medtronic_b33015(varargin)
...
electrode.coords_mm(2,:) = [0 0 4.65]+[0, elspec.lead_diameter/2, 0];
electrode.coords_mm(3,:) = [0 0 4.65]+[-cx, -cy, 0];
electrode.coords_mm(4,:) = [0 0 4.65]+[cx, -cy, 0];
