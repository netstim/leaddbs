function electrode=ea_elspec_fhc_wu_rat_electrode(varargin)
% Creates the FEM-compatible electrode model for FHC rat electrode used by WU.
...
modelFolder = 'FHC_WU_Rat_Electrode';

% Get specification
options.elmodel='FHC WU Rat Electrode';
...
electrode.tail_position = [0 0 elspec.tip_length*6.5]; % dummy value
