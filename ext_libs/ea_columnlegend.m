function [legend_h,object_h,plot_h,text_strings] = ea_columnlegend(numcolumns, data, str, varargin)
%
...
switch lower(location),
    ...
    case {'middle'}
        %set(legend_h, 'position', [mean(fig_pos(1:2)) pos(4)/2+pos(4)/4 pos(3) pos(4)]);
        legend_h.Position(1)=fig_pos(1)+fig_pos(3)/2-pos(3)/2;
        legend_h.Position(2)=-0.5;
...
% 
%    an=annotation('rectangle',[0,1,0,1]);
% an.Position=legend_h.Position;
%     an.FaceColor='none';
