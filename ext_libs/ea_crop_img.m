function [img2, transparency] = ea_crop_img(img,border)
%
...
%-----
% img2 = crop_img(img)
% [img2, transparency] = crop_img(img,border)
%
%
%INPUT
%-----
% - IMG: MxNxC matrix (where MxN is the size of the image and C is the
%   number of color layers) or path of the image
...
%-----
% - IMG2: cropped image
% - TRANSPARENCY: cropped image transparency
%
%EXAMPLE
%-------
% >> [img2, transparency] = crop_img('my_pic.png',0);
% >> imwrite(img2, 'my_cropped_pic.png', 'Alpha', transparency);
%
...
if exist('transparency', 'var')
    transparency = transparency(edge_row(1):edge_row(2),edge_col(1):edge_col(2));
end
