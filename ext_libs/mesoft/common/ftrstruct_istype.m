...
elseif strcmp(fiberType, 'fiberStruct')
    ...
    if any(strcmp(nameIndex, 'name')) && any(strcmp(nameIndex, 'curveID')) && any(strcmp(nameIndex, 'roiName')) && any(strcmp(nameIndex, 'user')) && ...
            (isempty(dataIn.name) || ischar(dataIn.name)) && ...
