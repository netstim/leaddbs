...
if refinewarp
    ...
    ea_conv_antswarps(ea_path_helper([cfg.outputbase, 'Composite.h5']), ea_path_helper(cfg.fixed), 'float');
    ea_conv_antswarps(ea_path_helper([cfg.outputbase, 'InverseComposite.h5']), ea_path_helper(cfg.moving), 'float');
end
