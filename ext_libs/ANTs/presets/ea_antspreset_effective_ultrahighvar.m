function apref = ea_antspreset_effective_ultrahighvar(cmd)

if ischar(cmd) % 'query' mode, return the name of the preset
    apref = 'Effective: Ultra High Variance';
    return
end
...
switch normsettings.ants_strategy
    ...
    case 'BSplineSyN'
        ...
        apref.antsmode_suffix='[0.1,26,0,1]'; % as in example script in Tustison 2013
...
apref.smoothingsigmas.syn='4x3x1x0vox'; % SyN Smoothing sigmas
