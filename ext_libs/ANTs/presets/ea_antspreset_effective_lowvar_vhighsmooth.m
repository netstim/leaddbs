function apref = ea_antspreset_effective_lowvar_vhighsmooth(cmd)

if ischar(cmd) % 'query' mode, return the name of the preset
    apref = 'Effective: Low Variance, very high Smoothing';
    return
end
...
apref.smoothingsigmas.syn='8x6x6x6vox'; % SyN Smoothing sigmas
apref.smoothingsigmas.scrf='8x6x6x6vox'; % SyN subcortical focus stage smoothing sigmas
