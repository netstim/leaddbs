...
'''
def call_ANN(ANN_folder, stim_vector, pathway, side):

    approx_model = load_model(os.path.join(ANN_folder, 'ANN_approved_model_' + pathway))
...
if __name__ == '__main__':
    ...
    call_ANN(ANN_folder, stim_vector, pathway, side)