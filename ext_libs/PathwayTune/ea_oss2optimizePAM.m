        ...
        for i = 1:settings.N_samples  % mutiple samples if probablistic PAM is used, otherwise 1
            ...
            if settings.calcAxonActivation
                ...
                if settings.prob_PAM
                    ...
                    system(['python ', ea_getearoot,'ext_libs',filesep,'PathwayTune',filesep,'pam_optimizer.py ', PAM_caller_script, ' ', neuron_folder, ' ', optim_settings_dict, ' ', outputPaths.outputDir, ' ', num2str(side)])
