...
ea_methods(options_recon,[ea_path_escape(mov),' was linearly co-registered to ',ea_path_escape(fix),' using FLIRT as implemented in FSL (Jenkinson 2001; Jenkinson 2002; https://fsl.fmrib.ox.ac.uk/)'],cits);
