...
if ispc
    applyTransforms = [basedir, 'applywarp.exe'];
else
    applyTransforms = [basedir, 'applywarp.', computer('arch')];
end
       ...
       if useinverse
           ...
           if exist('transformfile','var')
               ...
               tr=[' -r ',refim,...
                   ...
                   tr=[' -r ',refim,...
                       ' -w ',ea_path_helper([directory,glprebase]),'InverseCompositeCoeffs.nii.gz'];
           end
       else
           if isempty(refim)
           ...
           if exist('transformfile','var')
               ...
               tr=[' -r ',refim,...
                   ...
                   tr=[' -r ',refim,...
                       ' -w ',ea_path_helper([directory,glprebase]),'CompositeCoeffs.nii.gz'];
           end
       end
