function ea_get_ossdbs_StimSets_VTA(stim_vector, efield_contact_solutions, stim_i)
...
emagn.img = sqrt(dot(e_field_superimposed.img,e_field_superimposed.img,4)) * 1000.0;
