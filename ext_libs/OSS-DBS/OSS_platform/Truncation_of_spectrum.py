...
#            np.savetxt(f_handle,np.array([Xs_signal_norm.shape[0],inx_cutoff]))
        np.savetxt(os.environ['PATIENTDIR']+'/Stim_Signal/Indices_cutoff.csv', np.array([Xs_signal_norm.shape[0],inx_cutoff]), delimiter=" ")
...
#                        np.savetxt(f_handle,Fr_corresp_array)
                    ...
                    f=open(os.environ['PATIENTDIR']+'/Stim_Signal/Fr_corresp_array'+str(freq_param*1.0)+'.csv','ab')
...
def get_freqs_for_calc(d,FR_vector_signal,Xs_signal_norm,t_vector):
    ...
    if d["spectrum_trunc_method"]=='Octave Band Method' and not(os.path.isfile(os.environ['PATIENTDIR']+'/Stim_Signal/FR_vector_signal_octaves'+str(d["trunc_param"]*1.0)+'.csv')):
        ...
        Fr_corresp_array = np.genfromtxt(os.environ['PATIENTDIR']+'/Stim_Signal/Fr_corresp_array'+str(d["trunc_param"]*1.0)+'.csv', delimiter=' ')
        Fr_octave_vector = np.genfromtxt(os.environ['PATIENTDIR']+'/Stim_Signal/Fr_octave_vector_'+str(d["trunc_param"]*1.0)+'.csv', delimiter=' ')
    ...
    if d["spectrum_trunc_method"]=='Octave Band Method' and (os.path.isfile(os.environ['PATIENTDIR']+'/Stim_Signal/FR_vector_signal_octaves'+str(d["trunc_param"]*1.0)+'.csv')):
    ...
    if d["spectrum_trunc_method"]=='High Amplitude Method' and not(os.path.isfile(os.environ['PATIENTDIR']+'/Stim_Signal/FR_vector_signal_high_ampl'+str(d["trunc_param"])+'.csv')):
    ...
    if d["spectrum_trunc_method"]=='High Amplitude Method' and (os.path.isfile(os.environ['PATIENTDIR']+'/Stim_Signal/FR_vector_signal_high_ampl'+str(d["trunc_param"])+'.csv')):
        Xs_recovered_new = np.genfromtxt(os.environ['PATIENTDIR']+'/Stim_Signal/Xs_storage_high_ampl'+str(d["trunc_param"])+'.csv', delimiter=' ')
        Xs_signal_norm_new=np.vectorize(complex)(Xs_recovered_new[:,0],Xs_recovered_new[:,1])
        FR_vector_signal_new = np.genfromtxt(os.environ['PATIENTDIR']+'/Stim_Signal/FR_vector_signal_high_ampl'+str(d["trunc_param"])+'.csv', delimiter=' ')

        return FR_vector_signal_new,Xs_signal_norm_new

    if d["spectrum_trunc_method"]=='Cutoff Method' and not(os.path.isfile(os.environ['PATIENTDIR']+'/Stim_Signal/FR_vector_signal_cutoff'+str(d["trunc_param"])+'.csv')):
        from Truncation_of_spectrum import get_specific_freq
        FR_vector_signal_new,Xs_signal_norm_new = get_specific_freq(d["spectrum_trunc_method"],d["freq"],d["trunc_param"],FR_vector_signal,Xs_signal_norm,t_vector,d["T"])
    ...
    if d["spectrum_trunc_method"]=='Cutoff Method' and (os.path.isfile(os.environ['PATIENTDIR']+'/Stim_Signal/FR_vector_signal_cutoff'+str(d["trunc_param"])+'.csv')):
        Xs_recovered_new = np.genfromtxt(os.environ['PATIENTDIR']+'/Stim_Signal/Xs_storage_cutoff'+str(d["trunc_param"])+'.csv', delimiter=' ')
        Xs_signal_norm_new=np.vectorize(complex)(Xs_recovered_new[:,0],Xs_recovered_new[:,1])
        FR_vector_signal_new = np.genfromtxt(os.environ['PATIENTDIR']+'/Stim_Signal/FR_vector_signal_cutoff'+str(d["trunc_param"])+'.csv', delimiter=' ')
