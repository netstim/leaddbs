...
d = {
    ...
    'Brain_shape_name': '0',
    'Aprox_geometry_center': [11.6073625797459, -12.4183643136942, -9.94137279305384],
    'Approximating_Dimensions': [80.0, 80.0, 80.0],
    'Implantation_coordinate_X': 11.6074,
    'Implantation_coordinate_Y': -12.4184,
    'Implantation_coordinate_Z': -9.9414,
    'Second_coordinate_X': 13.9446,
    'Second_coordinate_Y': -8.3738,
    'Second_coordinate_Z': -3.9266,
    'Rotation_Z': -22.12,
    'encap_thickness': 0.1,
    'encap_tissue_type': 2,
    ...
    'FEniCS_MPI': 0,
    'current_control': 1,
    'Phi_vector': [None, -0.001, None, None, None, None, None, None],
    'Solver_Type': 'GMRES',
    'freq': 130.0,
    'T': 60.0,
    't_step': 1.0,
