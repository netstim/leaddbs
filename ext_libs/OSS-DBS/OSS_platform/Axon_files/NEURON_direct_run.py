...
#        hf.close()
    ...
    if population_index==-1:
        ...
        if d['Stim_side']==0:
            ...
            np.savetxt(os.environ['PATIENTDIR']+'/'+stim_folder+'Network_status.csv', Vert_full_status, delimiter=" ")  #Ningfei prefers .csv
        ...
        if d['Stim_side']==0:
            ...
            hf = h5py.File(os.environ['PATIENTDIR']+'/'+stim_folder+'Network_status.h5', 'a')
