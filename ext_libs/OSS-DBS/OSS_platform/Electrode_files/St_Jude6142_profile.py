...
Zt_tip=Zt-1.5		#for St Jude 6142
...
Contact_1_fake = geompy.MakePrismVecH(Circle_1, OZ, 0.75*stretch+0.75) #only stretch the lower part of the upper contact
...
Contact_2 = geompy.MakeTranslation(Contact_1_large, 0, 0, 3*stretch)
Contact_3 = geompy.MakeTranslation(Contact_1_large, 0, 0, 6*stretch)
Contact_4 = geompy.MakeTranslation(Contact_1_fake, 0, 0, 9*stretch)
...
CV2 = geompy.MakeTranslation(CV1_large, 0, 0, 3*stretch)
CV3 = geompy.MakeTranslation(CV1_large, 0, 0, 6*stretch)
CV4 = geompy.MakeTranslation(CV1_fake, 0, 0, 9*stretch)
##################################################################################################################
