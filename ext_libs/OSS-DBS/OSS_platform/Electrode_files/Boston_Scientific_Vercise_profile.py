...
geompy.TranslateDXDYDZ(Contact_1_full, 0, 0, 0.45)
...
Contact_4 = geompy.MakeTranslation(Contact_1_full, 0, 0, 5.25*stretch+0.75)
Contact_5 = geompy.MakeTranslation(Contact_1_full, 0, 0, 7.25*stretch+0.75)
Contact_6 = geompy.MakeTranslation(Contact_1_full, 0, 0, 9.25*stretch+0.75)
Contact_7 = geompy.MakeTranslation(Contact_1_full, 0, 0, 11.25*stretch+0.75)
Contact_8 = geompy.MakeTranslation(Contact_1, 0, 0, 13.25*stretch+0.75)
...
CV1 = geompy.MakeCylinderRH(0.65, 0.75*stretch+0.75)
geompy.TranslateDXDYDZ(CV1, 0, 0, 1.1)
CV1_full = geompy.MakeCylinderRH(0.65, 1.5*stretch)
geompy.TranslateDXDYDZ(CV1_full, 0, 0, 1.1)
CV2 = geompy.MakeTranslation(CV1_full, 0, 0, 1.25*stretch+0.75)
CV3 = geompy.MakeTranslation(CV1_full, 0, 0, 3.25*stretch+0.75)
CV4 = geompy.MakeTranslation(CV1_full, 0, 0, 5.25*stretch+0.75)
CV5 = geompy.MakeTranslation(CV1_full, 0, 0, 7.25*stretch+0.75)
CV6 = geompy.MakeTranslation(CV1_full, 0, 0, 9.25*stretch+0.75)
CV7 = geompy.MakeTranslation(CV1_full, 0, 0, 11.25*stretch+0.75)
CV8 = geompy.MakeTranslation(CV1, 0, 0, 13.25*stretch+0.75)
##################################################################################################################
