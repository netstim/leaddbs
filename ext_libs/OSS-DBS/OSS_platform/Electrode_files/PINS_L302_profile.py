...
CContact_1 = geompy.MakePrismVecH(Circle_1, OZ, 0.75*stretch+0.75)
...
Contact_2 = geompy.MakeTranslation(Contact_1_full, 0, 0, 2.25*stretch+0.75)
Contact_3 = geompy.MakeTranslation(Contact_1_full, 0, 0, 5.25*stretch+0.75)
Contact_4 = geompy.MakeTranslation(Contact_1, 0, 0, 8.25*stretch+0.75)
...
CV2 = geompy.MakeTranslation(CV1_full, 0, 0, 0.75+2.25*stretch)
CV3 = geompy.MakeTranslation(CV1_full, 0, 0, 5.25*stretch+0.75)
CV4 = geompy.MakeTranslation(CV1, 0, 0, 8.25*stretch+0.75)
##################################################################################################################
