...
geompy.Rotate(Fuse_all_lead_encap_ROI_no_internal_face, OZ1,45.0*math.pi/180.0)	 # hardwired turn because of the Lead-DBS definition (marker points and 1st contact point to Y-axis)s)
