...
def make_a_screenshot(path_to_insert):
	...
	cSF_Subdomains_unrefpvd = PVDReader(FileName=[home_dir+path_to_insert+'/CSF_ref/CSF_Subdomains_unref.pvd'])
	...
	renderView1.ResetCamera()
	SaveScreenshot(home_dir+path_to_insert+'/Images/CSF_unref.png', magnification=1, quality=100, view=renderView1)
