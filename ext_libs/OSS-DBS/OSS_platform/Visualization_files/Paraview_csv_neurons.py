...
def make_a_screenshot(path_to_insert):
	...
	#path_to_insert='/home/butenko/mnt/project/qiangconnectome/6002/'
        home_dir=os.path.expanduser("~")
        print(home_dir+path_to_insert+'/Neuron_model_arrays/Vert_of_Neural_model_NEURON.csv')
	...
	SaveScreenshot(home_dir+path_to_insert+'/Images/Placed_neurons.png', magnification=1, quality=100, view=renderView1)
