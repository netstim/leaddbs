...
ea_methods(options,['Pre- (and post-) operative acquisitions were spatially normalized into ',ea_getspace,' space based on preoperative acquisition(s) (',strjoin(ea_path_escape(modality), ', '),') using the'...
