...
if options.prefs.machine.normsettings.ants_scrf
    ...
    ea_methods(options,['Pre- (and post-) operative acquisitions were spatially normalized into ',ea_getspace,' space ',scit,' based on preoperative acquisition(s) (',ea_cell2strlist(ea_path_escape(imagePresent)),') using the'...
