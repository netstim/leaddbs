% configure file for eAuto in Matlabbatch
% BATCH system (Volkmar Glauche)
%
% File created by Susanne Schnell
%%
function eajobs = ea_cfg
...
eajobs.values  = {ea_cfg_normalize ea_cfg_reconstruct ea_cfg_manualheight ea_cfg_slice ea_cfg_renderview ea_cfg_stimulation};
