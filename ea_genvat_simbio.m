...
[cimat,~,mat]=ea_sample_cuboid(trajvox,options,[options.earoot,'atlases',filesep,options.atlasset,filesep,'gm_mask.nii'],0,50);
mat=mat';
...
lf=leadfield_simbio(dipoleposition,vol);
