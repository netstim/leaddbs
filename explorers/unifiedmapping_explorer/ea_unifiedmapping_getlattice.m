function [vatlist,FilesExist] = ea_unifiedmapping_getlattice(obj)
% Return list of VATs
...
for sub=1:numPatient
    ...
    stimFolder = [obj.allpatients{sub}, filesep, 'stimulations', filesep, ea_unifiedmapping_nt(obj.calcsettings.calcspace), 'gs_', obj.M.guid];
