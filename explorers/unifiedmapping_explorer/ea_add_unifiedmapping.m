function ea_add_unifiedmapping(~,~,leadgroup,resultfig)
...
if ismember('M', who('-file',leadgroup)) % Add new network mapping analysis
    exp = ea_unifiedmappingexplorer(leadgroup,resultfig);
    ...
    uipushtool(ht, 'CData', ea_get_icn('connectivities'),...
        ...
        'ClickedCallback', {@ea_add_unifiedmapping,[fileparts(leadgroup),filesep,'UnifiedMappingExplorer',filesep,dbsmappingId,'.explorer'],resultfig});
    ...
    ea_unifiedmappingexplorer(leadgroup, resultfig);
end
