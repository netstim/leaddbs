...
prefs = ea_prefs;
try
    thresh = obj.calcsettings.calcthreshold;
catch
...
for side = 1:numSide
    ...
    for pt = 1:numPatient
        ...
        if pt <= length(obj.allpatients)
            ...
            if side == 1
                E_proj_folder = [obj.allpatients{pt-size(obj.allpatients,1)},filesep,'connectomes',filesep,'dMRI',filesep,obj.calcsettings.fibfilt_connectome,filesep,'gs_', obj.M.guid,'_lh'];
            else
                E_proj_folder = [obj.allpatients{pt-size(obj.allpatients,1)},filesep,'connectomes',filesep,'dMRI',filesep,obj.calcsettings.fibfilt_connectome,filesep,'gs_', obj.M.guid,'_rh'];
            end
