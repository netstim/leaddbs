function vatlist = ea_unified_nm_getvats(obj)
% Return list of VATs
...
[~,ix] = ismember(obj.calcsettings.netmap_connectome,modlist);
if ~ix
...
options.lcm.struc.connectome = obj.calcsettings.netmap_connectome;
options.lcm.struc.espace = 1;
options.lcm.func.do = 0;
options.lcm.func.exportgmtc = 0;
options.lcm.func.connectome = strrep(obj.calcsettings.netmap_connectome,' > ','>');
options.lcm.cmd = 1;
