function [cfile, map_list, pathway_list] = ea_unifiedmapping_mergePathways(obj)
...
myDir = [ea_getconnectomebase('dMRI_MultiTract'), obj.calcsettings.fibfilt_connectome];
    ...
    for side = 1:2 % hardcoded
        for k=1:length(myFiles)
            ...
            pam_result_folder = [pthprefix, obj.allpatients{sub},filesep, 'stimulations',filesep,...
                ea_nt(0), 'gs_',obj.M.guid, filesep, obj.calcsettings.fibfilt_connectome, filesep, 'PAM'];
