function vals=ea_explorer_corrsignan(vals,ps,obj)
allvals=cat(1,vals{:});
allps=cat(1,ps{:});
...
switch lower(obj.thresholding.multcompstrategy)
    case 'fdr'
...
allvals(allps>obj.thresholding.alphalevel)=nan; % delete everything nonsignificant.
