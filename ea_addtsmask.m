...
disp('Registering subcortical mask (Schoenecker 2008) to subject preoperative anatomy...');
    ...
    copyfile([ea_getearoot,'templates',filesep,'mni_hires_',options.primarytemplate,'.nii'],[options.root,options.patientname,filesep,'tmp.nii']);
    copyfile([ea_getearoot,'templates',filesep,'schoenecker',filesep,'secondstepmask.nii'],[options.root,options.patientname,filesep,'bgmsk.nii']);
