...
python_commands = [strcat("slicer.app.settings().setValue('NetstimPreferences/leadDBSPath','", ea_getearoot, "')");...
                    ...
                    "import WarpDrive";...
                    strcat("WarpDrive.WarpDriveLogic().getParameterNode().SetParameter('LeadSubjects',json.dumps(json.load(open('", tmp_file, "'))))");...
                    strcat("WarpDrive.WarpDriveLogic().getParameterNode().SetParameter('MNIPath','", ea_space, "')");...
                    strcat("os.remove('", tmp_file, "')");...
