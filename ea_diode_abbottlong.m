function [roll_y,y,solution] = ea_diode_abbottlong(side,ct,head_mm,unitvector_mm,tmat_vx2mm)
msg = sprintf(['Warning: DiODe has not been phantom-validated for Abbott direcional leads!']);
...
markercenterRelative = 12;
load('stjude_directed_15');
