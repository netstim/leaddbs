        ...
        switch options.reconmethod
            ...
            case 2 % PaCER
                ...
                ea_methods(options,...
                    ...
                    ' (Husch 2017; http://adhusch.github.io/PaCER/).'],...
                    {'Husch (2017). PaCER - A fully automated method for electrode trajectory and contact reconstruction in deep brain stimulation.'});
        end
