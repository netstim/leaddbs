...
connectomes={'HCP_MGH_30fold_groupconnectome (Horn 2017)','GSP 1000 (Yeo 2011)_Full Set (Yeo 2011)'}; % specify which connectomes were run / which ones to import
types={'dMRI','fMRI'}; % specify types for each connectome (dMRI/fMRI)
% add data from HCP 30 dMRI:
for c=1:length(connectomes)
    ...
    modeldata.updrs3percimprov=imptovements;
