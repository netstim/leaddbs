...
connectomes={'HCP_MGH_30fold_groupconnectome (Horn 2017)','GSP 1000 (Yeo 2011)_Full Set (Yeo 2011)','PPMI 74_15 (Horn 2017)_Patients'}; % specify which connectomes were run / which ones to import
types={'dMRI','fMRI','fMRI'}; % specify types for each connectome (dMRI/fMRI)
load modeldata
