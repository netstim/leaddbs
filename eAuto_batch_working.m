...
patdirs={'AdamLukas','BouchenafaIn','NajorkM','NeubauerOswa','SchlotteO','SchlotteH','SchroterWalt','TheelkeW','Fintel'};
%patdirs={'NajorkM','NeubauerOswa'};
%patdirs={'NeubauerOswa'};
...
options.zheights=1; % if 1: use cor only, 2: use smoothed version of cor only, if 3: use mean of cor and tra, if 4: use multiplied cor * tra 5: use ^10 version of cor, 6: use ^10 version of cor.*tra 7: smoothed and then like 5. -> to determine heights of electrode contacts.
