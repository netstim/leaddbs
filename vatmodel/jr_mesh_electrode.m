function [oemesh,nmesh,activeidx,wmboundary,centroids,tissuetype,conts]=jr_mesh_electrode(fv,elfv,eltissuetype,electrode,options,S,side,elnumel,transformmatrix,elspec)
