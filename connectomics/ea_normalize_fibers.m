...
reftemplate=[options.earoot,'templates',filesep,'dartel',filesep,'rdartelmni_1.nii,2'];
...
try
    reftemplate=[options.earoot,'templates',filesep,'dartel',filesep,'rdartelmni_1.nii'];
    dnii=ea_load_nii(reftemplate);
