...
if isequal(seed.mat,dataset.vol.space.mat)
    warning(['Based on Nifti headers, seed ',seed.fname,' seems in the correct space for connectome. No reslicing applied. If this is not the case, results will be wrong. Please check and ensure.']);
else
