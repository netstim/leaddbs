...
for run=1:chunk:length(sfile)
    ...
    if regexp(options.lcm.func.connectome, '^Patient''s fMRI - ', 'once')
        ...
        switch ea_lcm_resolvecmd(options.lcm.cmd)
            case 'seed'
                switch d.dataset.type
                    case 'fMRI_matrix'
                        cs_fmri_conseed_seed_matrix(ea_getconnectomebase,options.lcm.func.connectome,...
                            tsfile,...
                    ...
                    case 'fMRI_timecourses'
                        cs_fmri_conseed_seed_tc(ea_getconnectomebase,options.lcm.func.connectome,...
                            tsfile,...
                            ea_lcm_resolvecmd(options.lcm.cmd),...
                            '0',...
                            options.lcm.odir,...
            ...
            case 'pseed'
                 switch d.dataset.type
                    ...
                    case 'fMRI_timecourses'
                cs_fmri_conseed_pseed(ea_getconnectomebase,options.lcm.func.connectome,...
                    tsfile,...
                    ea_lcm_resolvecmd(options.lcm.cmd),...
                    '0',...
                    options.lcm.odir,...
            ...
            case {'matrix','pmatrix'}
                switch d.dataset.type
                    case 'fMRI_matrix'
                        ea_error('Command partial seed is not supported for matrix type datasets.')
                    case 'fMRI_timecourses'
                        cs_fmri_conseed_matrix(ea_getconnectomebase,options.lcm.func.connectome,...
                            tsfile,...
                            ea_lcm_resolvecmd(options.lcm.cmd),...
                            '0',...
                            options.lcm.odir,...
            ...
            case 'pmap'
                switch d.dataset.type
                    case 'fMRI_matrix'
                        ea_error('Command partial seed is not supported for matrix type datasets.')
                    case 'fMRI_timecourses'
                cs_fmri_conseed_pmap(ea_getconnectomebase,options.lcm.func.connectome,...
                    tsfile,...
                    ea_lcm_resolvecmd(options.lcm.cmd),...
                    '0',...
                    options.lcm.odir,...
