...
elseif exist([ea_getearoot,'templates',filesep,'space',filesep,ea_getspace,filesep,'need_install'],'file')
    if ~(exist([ea_getearoot,'.git'],'dir') && ... % dev environment ('need_install' is always there) && space not downloaded
         exist([ea_getearoot,'templates',filesep,'space',filesep,ea_getspace,filesep,'ea_space_def.mat'],'file'))
