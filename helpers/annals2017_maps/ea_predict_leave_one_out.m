...
if ~exist('fdmri','var')
    fdmri='both'; % can be fmri, dmri or both
end

for pat=1:length(uipatdirs)
    fis.fmri{pat}=[uipatdirs{pat},filesep,'stimulations',filesep,stimname,filesep,'vat_seed_compound_fMRI_func_seed_AvgR_Fz.nii'];
    fis.dmri{pat}=[uipatdirs{pat},filesep,'stimulations',filesep,stimname,filesep,'vat_seed_compound_dMRI_struc_seed.nii'];
end
