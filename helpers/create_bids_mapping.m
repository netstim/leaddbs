function [brainshift_corr,coreg,normalization,preproc,recon,prefs,stimulations,headmodel] = create_bids_mapping()
%create a list of old files along with their full path:
%%



brainshift_corr{:,1} = {'movim.nii';...
                        'bgmsk.nii';...
                        'bgmsk2.nii';...
                        'scrfmovim.nii';...
                        'anat_t1.nii';...
                        ...
                        'standard.png';...
                        'ea_methods.txt'};
brainshift_corr{:,2} = {'space-anchorNative_rec-brainshift_desc-preproc_ses-postop_CT.nii';...
...
coreg{:,2} =  { 'space-anchorNative_desc-preproc_ses-postop_CT.nii';...
...
preproc{:,1} = {'postop_ct.nii';...
               'raw_postop_tra.nii';...
               'raw_postop_cor.nii';...
               'raw_postop_sag.nii';...
               'raw_anat_t1.nii';...
               'raw_anat_t2.nii'};
preproc{:,2} = {'desc-preproc_ses-postop_CT.nii';...
...
recon{:,1} = {'ea_reconstruction.mat';
     'rct_mask.nii';...
     'ct_mask.nii'};
recon{:,2} = {'desc-reconstruction.mat';...
