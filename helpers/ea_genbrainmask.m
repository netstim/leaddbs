...
if isBIDSFileName(filePath)
    c1.fname = setBIDSEntity(filePath, 'label', 'Brain', 'suffix', 'mask');
    movefile([directory, filesep, 'c1', fileName, '.nii'], setBIDSEntity(filePath, 'label', 'GM', 'suffix', 'mask'));
    movefile([directory, filesep, 'c2', fileName, '.nii'], setBIDSEntity(filePath, 'label', 'WM', 'suffix', 'mask'));
    movefile([directory, filesep, 'c3', fileName, '.nii'], setBIDSEntity(filePath, 'label', 'CSF', 'suffix', 'mask'));
else
