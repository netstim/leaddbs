...
if exist([ea_getearoot,'templates',filesep,'mni_hires_t1.nii'],'file');
    ...
    mkdir([ea_getearoot,'templates',filesep,'space',filesep,'mni_icbm2009b']);
    movefile([ea_getearoot,'templates_temp'],[ea_getearoot,'templates',filesep,'space',filesep,'mni_icbm2009b',filesep,'templates']);
    
    movefile([ea_getearoot,'atlases'],[ea_getearoot,'templates',filesep,'space',filesep,'mni_icbm2009b',filesep,'atlases']);
