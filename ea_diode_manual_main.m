function ea_diode_manual_main(options)
...
for side = options.elside
    ...
    [roll_y,y,solution] = ea_diode_manualGUI(side,ct,head_mm,unitvector_mm,tmat_vx2mm,options.elspec);
    ...
    if ~isempty(y)
        ...
        reco.angles.orientationmethod{options.elside} = 'manualGUI';
