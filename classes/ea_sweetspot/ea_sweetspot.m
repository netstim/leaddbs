classdef ea_sweetspot < handle
    ...
    % example:
    % figure; pobj.openedit=1; ea_sweetspot([spm('dir'),filesep,'toolbox',filesep,'OldSeg',filesep,'grey.nii'],pobj); a=light; axis('off','equal')
    % A. Horn
    ...
    methods
        function obj=ea_sweetspot(niftiFilename,pobj) % generator function
