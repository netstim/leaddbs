...
if ~isfield(options.prefs,'firstrun') % first run.
    ...
    if ~exist([ea_space,'bb.nii'], 'file')
        ea_cprintf('CmdWinWarnings', ['\nIt seems that you don''t have LEAD dataset installed.\n' ...
                 ...
                 'or download it from https://www.lead-dbs.org/release/download.php?id=data_classic_pcloud or\n' ...
                 'https://www.lead-dbs.org/release/download.php?id=data_classic_onedrive and then extract it into LEAD folder.\n\n']);
