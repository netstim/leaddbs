...
% matlabbatch{1}.spm.tools.dartel.warp1.settings.param(1).template = {[ea_space('dartel'),'shootmni_1.nii']};
...
% matlabbatch{1}.spm.tools.dartel.warp1.settings.param(2).template = {[ea_space('dartel'),'shootmni_2.nii']};
...
% matlabbatch{1}.spm.tools.dartel.warp1.settings.param(3).template = {[ea_space('dartel'),'shootmni_3.nii']};
...
% matlabbatch{1}.spm.tools.dartel.warp1.settings.param(4).template = {[ea_space('dartel'),'shootmni_4.nii']};
...
% matlabbatch{1}.spm.tools.dartel.warp1.settings.param(5).template = {[ea_space('dartel'),'shootmni_5.nii']};
...
% matlabbatch{1}.spm.tools.dartel.warp1.settings.param(6).template = {[ea_space('dartel'),'shootmni_6.nii']};
...
matlabbatch{1}.spm.tools.shoot.warp1.templates = {[ea_space('dartel'),'shootmni_1.nii']
    [ea_space('dartel'),'shootmni_2.nii']
    [ea_space('dartel'),'shootmni_3.nii']
    [ea_space('dartel'),'shootmni_4.nii']
    [ea_space('dartel'),'shootmni_5.nii']
    [ea_space('dartel'),'shootmni_6.nii']};
  jobs{1}=matlabbatch;                                            
