...
movefile([directory, 'c1', preopAnchorName, '.nii'], setBIDSEntity(preopImages{1}, 'mod', options.subj.AnchorModality, 'label', 'GM', 'suffix', 'mask'));
movefile([directory, 'c2', preopAnchorName, '.nii'], setBIDSEntity(preopImages{1}, 'mod', options.subj.AnchorModality, 'label', 'WM', 'suffix', 'mask'));
movefile([directory, 'c3', preopAnchorName, '.nii'], setBIDSEntity(preopImages{1}, 'mod', options.subj.AnchorModality, 'label', 'CSF', 'suffix', 'mask'));
